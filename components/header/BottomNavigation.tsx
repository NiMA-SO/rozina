...
const BottomNavigation: React.FC = () => {
  return (
    <>
      <nav aria-label="Secondary navigation" className="h-full hidden lg:block">
        <div className="container mx-auto h-full flex items-center px-1.5">
          <NavigationMain />
        </div>
      </nav>
      <nav aria-label="Mobile quick actions" className="h-full block lg:hidden">
        <div className="container mx-auto h-full flex items-center justify-between px-1.5">
          ...
          >
            <span className="text-[var(--primary-foreground)] font-[shabnamLight]">
              ورود و عضویت
            </span>
